...
For visual optimization, read `docs/handover/portal-ui-standards-v1.md` and `docs/handover/project-ui-standards-v1.md` before editing project pages so typography, color roles, icon sizing, logo/avatar handling, workspace tables, side panels, and control states stay aligned with the Portal baseline.
